...
if(isset($_GET['id'])){
  ...
  while($row = fetch_array($query)){
    ...
    $product_image_secondary = escape_string($row['product_image_secondary']);
...
<!--     <div class="form-group">
    ...
    <div class="form-group">
        ...
        <img src="../../resources/<?php echo $product_image; ?>" width="100">
      
    </div>

    <div class="form-group">
        <label for="product-title">Secondary Product Image</label>
        <input type="file" name="file2"><br>
        <img src="../../resources/<?php echo $product_image_secondary; ?>" width="100">
